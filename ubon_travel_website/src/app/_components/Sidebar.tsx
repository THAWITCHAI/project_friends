...
export default function Sidebar({ }: Props) {
  ...
  return (
    <div className="w-[15%] h-full flex flex-col justify-start items-center overflow-y-scroll scrollbar-hide">
      ...
      <span className="rounded-md w-[9rem] py-2 h-fit my-2 flex justify-center items-center hover:bg-blue-500 hover:text-white text-blue-500 active:scale-90 transition-all ease-in-out hover:scale-125">
      ...
      {data.map((item, index) => {
        return (
          <span
            className="hover:border rounded-md w-[9rem] py-2 h-fit my-2 flex justify-center items-center hover:bg-blue-500 hover:text-white text-blue-500 active:scale-90 transition-all ease-in-out hover:scale-125"
            key={index}
          >
