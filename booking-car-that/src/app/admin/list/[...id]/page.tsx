          ...
          >
            ...
            <div className="w-full h-32 text-white text-5xl flex justify-center items-center bg-green-500 rounded-lg">{item['sname']}</div>
              ...
              <div className=" h-[20rem] w-full">
                <h1 className="w-full h-1/4 text-2xl text-black flex justify-center items-center">หมายเหตุ</h1>
                <p className="w-full h-[75%] text-red-500 flex justify-center items-center text-2xl">{item['bnot']}</p>
              </div>
